    ...
    <div className="navbar  dark:bg-black shadow-sm transition-all duration-300 top-0 z-50">
      <div className="navbar-start">
        ...
        <Link to="/" className="flex items-center ml-2">
          <img
            className="w-18 bg-amber-500 p-0.5 rounded-2xl mr-2"
            src={logo}
            alt="Savory Spoon Logo"
          />
          {/* <span className="text-xl font-bold bg-gradient-to-r from-amber-600 to-amber-800 bg-clip-text text-transparent dark:from-amber-400 dark:to-amber-300">
            Savory Spoon
          </span> */}
        </Link>
      </div>
