...
const InteractiveChefsTable = () => {
  ...
  // Chef data with reliable Unsplash image URLs
  const chefs = [
    {
      id: 1,
      name: "Marco Russo",
    ...
    },
    {
      ...
      rating: 4.7,
      image: "https://images.unsplash.com/photo-1595476108010-b4d1f102b1b1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80",
  ...
  const fallbackImage = "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80";

  return (
    <div className="bg-gradient-to-b from-amber-50 to-white py-20 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-16 bg-gradient-to-r from-orange-500 to-amber-600"></div>
      <div className="absolute top-1/4 right-0 w-32 h-32 rounded-full bg-amber-200/30 blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full bg-orange-300/20 blur-3xl"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {chefs.map((chef) => (
            <motion.div
              ...
              className={`bg-white rounded-xl shadow-lg overflow-hidden cursor-pointer transition-all ${selectedChef?.id === chef.id ? 'ring-4 ring-orange-400' : ''}`}
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center mb-3">
                  ...
                  <span className="text-gray-700">{chef.specialty}</span>
                </div>
                <div className="flex items-center">
                  <FaRegClock className="text-orange-500 mr-2" />
                  <span className="text-gray-700">{chef.experience} experience</span>
                </div>
              </div>
            </motion.div>
          ))}
                  ...
                  <div className="flex flex-col md:flex-row gap-8">
                    <div className="md:w-1/3">
                      <div className="bg-amber-50 rounded-xl p-6 mb-6">
                        ...
                        <p className="text-gray-700 mb-4">{selectedChef.bio}</p>
                        <div className="space-y-3">
                          <div className="flex items-center">
                            <FaStar className="text-amber-500 mr-2" />
                            <span className="text-gray-700"><strong>{selectedChef.rating}</strong> rating</span>
                          </div>
                          <div className="flex items-center">
                            <FaRegClock className="text-orange-500 mr-2" />
                            <span className="text-gray-700"><strong>{selectedChef.experience}</strong> experience</span>
                          </div>
                          <div className="flex items-center">
                            <GiCookingPot className="text-orange-500 mr-2" />
                            <span className="text-gray-700">Specializes in <strong>{selectedChef.specialty}</strong></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="md:w-2/3">
                      <div className="flex border-b border-gray-200 mb-6">
                        <button
                          className={`px-4 py-2 font-medium ${activeTab === 'signature' ? 'text-orange-500 border-b-2 border-orange-500' : 'text-gray-500'}`}
                        ...
                        {selectedChef.dishes
                          ...
                          .map(dish => (
                            <motion.div
                              ...
                              transition={{ duration: 0.3 }}
                              className="flex flex-col sm:flex-row gap-4 p-4 bg-gray-50 rounded-lg hover:bg-amber-50 transition-colors"
                            >
                              <div className="sm:w-1/4 bg-white p-3 rounded-lg flex items-center justify-center">
